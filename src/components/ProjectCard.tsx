        ...
        <div className="relative overflow-hidden rounded-lg bg-gray-900 shadow-xl transition-all duration-300 group-hover:shadow-2xl h-full">
            ...
            <div className="absolute inset-0 bg-linear-to-t from-black/90 via-black/50 to-transparent opacity-0 transition-opacity duration-300 group-hover:opacity-100 flex flex-col justify-end p-6 pointer-events-none">
                ...
                <div className="translate-y-4 transition-transform duration-300 delay-75 group-hover:translate-y-0">
                    ...
                    {project.composer && (
                        <p className="text-gray-400 text-xs font-mono mt-0.5">Composer - {project.composer}</p>
                    )}
                </div>
                <div className="flex justify-between items-center mt-2 translate-y-4 transition-transform duration-300 delay-100 group-hover:translate-y-0">
                    <span className="text-sm font-blackout text-gray-500 uppercase tracking-widest">{project.year}</span>
                    {project.link && (
                        <span className="text-sm font-blackout text-white border border-white/30 px-2 py-1 rounded-full bg-black/60 backdrop-blur-sm">View &rarr;</span>
                    )}
                </div>
            </div>
        </div>
